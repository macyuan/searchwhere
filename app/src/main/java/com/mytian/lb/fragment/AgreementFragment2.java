...
public class AgreementFragment2 extends AbsFragment implements BaiduMap.OnMapStatusChangeListener, NavMenuView, NavMenuDetailView {
...
//                        .fromResource(R.mipmap.bg_location);
                ...
                //改变地图状态
                mBaiduMap.animateMapStatus(mMapStatusUpdate);
                mBaiduMap.setOnMapStatusChangeListener(AgreementFragment2.this);
                isFirstEnter = true;
    ...
    class NavMenuAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        class NavMenuHolder extends RecyclerView.ViewHolder {
            ...
            public NavMenuHolder(View itemView) {
                super(itemView);
                ButterKnife.bind(getActivity(), itemView);
            }
        }
