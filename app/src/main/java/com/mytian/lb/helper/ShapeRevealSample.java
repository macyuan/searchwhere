...
public class ShapeRevealSample {
    ...
    public static void play(TextSurface textSurface, final ECallOnClick onClick) {
        ...
        Text textA = TextBuilder.create("众里寻她千百度").setColor(fontColor).setSize(fontSize).setPosition(Align.SURFACE_CENTER).build();
        Text textB = TextBuilder.create("蓦然回首").setColor(fontColor).setSize(fontSize).setPosition(Align.BOTTOM_OF | Align.CENTER_OF, textA).build();
        Text textC = TextBuilder.create("那人却在").setColor(fontColor).setSize(fontSize).setPosition(Align.BOTTOM_OF | Align.CENTER_OF, textB).build();
        Text textD = TextBuilder.create("灯火阑珊处").setColor(fontColor).setSize(fontSize).setPosition(Align.BOTTOM_OF | Align.CENTER_OF, textC).build();
        Text textE = TextBuilder.create("                                                 --辛弃疾").setColor(fontColor).setSize(fontSize).setPosition(Align.BOTTOM_OF | Align.CENTER_OF, textD).build();
